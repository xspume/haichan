...
export function BoardsToolbar() {
  ...
  return (
    <div className="flex items-center gap-1 text-[11px] font-sans px-3 h-full bg-black overflow-x-auto whitespace-nowrap custom-scrollbar no-scrollbar">
      <span className="text-primary/80 font-black uppercase tracking-widest mr-1 text-[9px]">boards:</span>
